  ...
  return (
    <div className="space-y-8">
      <div className="max-w-3xl">
        <h1 className="text-3xl font-bold mb-4">Starknet Contracts Documentation</h1>
        <p className="text-muted-foreground text-lg">
          Practical examples for building smart contracts on Starknet using the Cairo programming language. Browse
          through our documentation to learn how to build on Starknet.
        </p>
      </div>
