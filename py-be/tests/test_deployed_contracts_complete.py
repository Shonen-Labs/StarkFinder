...
class TestDeployedContractsEndpoint:
    ...
    def test_valid_request_with_deployed_contracts(self, mock_get_db, db_session):
        ...
        mock_db.query.return_value.filter.return_value.order_by.return_value.all.return_value = mock_contracts
    ...
    def test_sorting_by_deployed_at_desc(self, mock_get_db, db_session):
        ...
        response = client.get("/deployed_contracts", params={"sort_by": "deployed_at", "order": "desc"})
    ...
    def test_sorting_by_deployed_at_asc(self, mock_get_db, db_session):
        ...
        response = client.get("/deployed_contracts", params={"sort_by": "deployed_at", "order": "asc"})
    ...
    def test_sorting_by_contract_name_asc(self, mock_get_db, db_session):
        ...
        response = client.get("/deployed_contracts", params={"sort_by": "contract_name", "order": "asc"})
    ...
    def test_sorting_by_contract_name_desc(self, mock_get_db, db_session):
        ...
        response = client.get("/deployed_contracts", params={"sort_by": "contract_name", "order": "desc"})
    ...
    def test_combined_filtering_and_sorting(self, mock_get_db, db_session):
        ...
        response = client.get("/deployed_contracts", params={
            "name": "Contract",
            "sort_by": "deployed_at",
            "order": "desc"
        })
    ...
    def test_invalid_sort_by_field(self, mock_get_db, db_session):
        ...
        response = client.get("/deployed_contracts", params={"sort_by": "invalid_field"})
    ...
    def test_response_data_structure(self, mock_get_db, db_session):
        ...
        contract = data[0]
        required_fields = ["id", "contract_name", "contract_address", "contract_metadata", "deployed_at"]
    ...
    def test_contract_metadata_handling(self, mock_get_db, db_session):
        contracts_with_metadata = [
            {
                ...
                "contract_metadata": {"version": "1.0", "features": ["feature1", "feature2"]},
                "deployed_at": self.now
            },
            {
                "id": 2,
        ...
        with_metadata = next(c for c in data if c["contract_name"] == "ContractWithMetadata")
        without_metadata = next(c for c in data if c["contract_name"] == "ContractWithoutMetadata")
        
        assert with_metadata["contract_metadata"] == {"version": "1.0", "features": ["feature1", "feature2"]}
